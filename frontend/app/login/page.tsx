      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4">
        <div className="bg-white dark:bg-zinc-900 py-8 px-6 rounded-lg border border-zinc-200 dark:border-zinc-800">
          ...
          <div className="mt-6 flex flex-col gap-4 text-center">
             <Link href="/register" className="text-sm font-medium text-zinc-500 hover:text-zinc-950 dark:text-zinc-400 dark:hover:text-zinc-200 transition-colors">
                Don&apos;t have an account? Sign up
             </Link>
             <Link href="/dashboard" className="text-sm font-medium text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300 transition-colors">
